  ...
  return (
    ...
    >
      <div className="relative z-10">
        <div className="mb-5 inline-block rounded-full border border-gold/40 px-4 py-1.5 text-[0.7rem] font-medium uppercase tracking-[0.2em] text-gold">
          📍 Vancouver · Open Now
        </div>
        <h1 className="mb-4 font-playfair text-[clamp(2.5rem,6vw,4.5rem)] font-bold leading-tight text-crema">
          Authentic Italian Pizza,
          <br />
          <em className="text-rosso italic">Every Slice.</em>
        </h1>
